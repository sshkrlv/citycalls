 ...
 * @property RelatedCalls[] $relatedCalls
 * @property RelatedCalls[] $relatedCalls0
 * @property Call[] $relatedCalls1
 * @property Call[] $calls
 * @property Review[] $reviews
 * @property SolutionForCall[] $solutionForCalls
 * @property Solution[] $solutions
 */
class Calal extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(RelatedCalls::className(), ['callId' => 'callId']);
    }

    /**
     * Gets query for [[RelatedCalls0]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getRelatedCalls0()
    {
        return $this->hasMany(RelatedCalls::className(), ['relatedCallId' => 'callId']);
    }

    /**
     * Gets query for [[RelatedCalls1]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getRelatedCalls1()
    {
    ...
    {
        return $this->hasMany(Call::className(), ['callId' => 'callId'])->viaTable('relatedCalls', ['relatedCallId' => 'callId']);
    }
